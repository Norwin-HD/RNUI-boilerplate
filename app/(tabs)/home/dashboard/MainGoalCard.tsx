...
const MainGoalCard = ({
  ...
  const percentage =
    totalAmount > 0 ? Math.round((currentAmount / totalAmount) * 100) : 0;
  ...
  return (
    <Card style={styles.containerCard}>
      ...
      <View style={styles.middleContainer}>
        ...
        <Text style={styles.deadlineText}>{formatShortDate(deadline)}</Text>
      </View>
      <View style={styles.progressContainer}>
        ...
        <View style={styles.progressTextContainer}>
          ...
          >{`$${currentAmount} de $${totalAmount}`}</Text>
          <Text
            style={styles.percentageText}
          >{`${percentage}% completado`}</Text>
        </View>
      </View>
    </Card>
  );
