...
export function Calendar({ onApply }: CalendarProps) {
  ...
  const [selected, setSelected] = useState<{ startDate?: DateType; endDate?: DateType } | undefined>(undefined);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerRow}>
        <Text style={styles.headerTitle}>Seleccionar período</Text>
        <TouchableOpacity
          style={styles.applyRow}
          onPress={() => {
            const start = selected?.startDate ? new Date(selected.startDate as any) : null;
            const end = selected?.endDate ? new Date(selected.endDate as any) : null;
            onApply?.(start, end);
          }}
        >
      ...
      <View style={styles.pickerWrap}>
        <DateTimePicker
          ...
          onChange={({ startDate, endDate }) => setSelected({ startDate, endDate })}
      ...
      <View style={styles.quickButtonsRow}>
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            setSelected({ startDate: today as unknown as DateType, endDate: today as unknown as DateType });
          }}
        >
